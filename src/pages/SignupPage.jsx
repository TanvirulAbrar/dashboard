...
export default function SignupPage() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    console.log('Signup attempt:', { fullName, email, password, termsAccepted });
  };
          ...
          <main className="flex flex-1 items-center justify-center px-4 py-12">
            <div className="layout-content-container flex flex-col w-full max-w-[480px] bg-white dark:bg-slate-900 p-8 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-800">
              ...
              <form className="flex flex-col gap-5" onSubmit={handleSubmit}>
                ...
                {/* Submit Button */}
                <button 
                  className="flex w-full cursor-pointer items-center justify-center overflow-hidden rounded-xl h-14 px-4 bg-primary text-[#172211] text-base font-bold leading-normal tracking-[0.015em] hover:opacity-90 transition-opacity mt-2 shadow-lg shadow-primary/20" 
                  type="submit"
                >
                ...
                <div className="flex gap-4">
                  <button className="flex flex-1 items-center justify-center gap-2 rounded-xl border border-slate-200 dark:border-slate-700 h-12 bg-white dark:bg-slate-800 hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors">
